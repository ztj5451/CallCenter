...
public class PortConfigurationActivity extends Activity {
	...
	private TextView tvPortInfo = null;
	private Button btConnect = null;
	private LinearLayout llEthernet = null;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == REQUEST_ENABLE_BT) {
			...
			if (resultCode == Activity.RESULT_OK) {
				...
				tvPortInfo.setText(getString(R.string.bluetooth_address)
						+ address);
				btConnect.setVisibility(View.VISIBLE);
	...
	public void okButtonClicked(View view) {
		...
		bundle.putString(GpPrintService.BLUETOOT_ADDR,
				mPortParam.getBluetoothAddr());
		bundle.putString(GpPrintService.USB_DEVICE_NAME,
				mPortParam.getUsbDeviceName());
