...
public class ServerPersonJDAdapter extends BaseAdapter {
	private Context mContext;

	private List<ServerPersonJD> mDdgwslList;

	public ServerPersonJDAdapter(Context context,
			List<ServerPersonJD> dwgwslList) {
		mContext = context;
