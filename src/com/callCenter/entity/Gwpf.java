...
public class Gwpf {
	...
	private String zbbmName;
	private String jdbmName;
	private String zt;
	...
	public String getTuidan() {
		return tuidan;
	}

	public void setTuidan(String tuidan) {
		this.tuidan = tuidan;
	}
	...
	public String getJdbmname() {
		return jdbmname;
	}

	public void setJdbmname(String jdbmname) {
		this.jdbmname = jdbmname;
	}
	...
	public String getZbbmName() {
		return zbbmName;
	}

	public void setZbbmName(String zbbmName) {
		this.zbbmName = zbbmName;
	}
