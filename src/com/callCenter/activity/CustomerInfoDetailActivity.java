 ...
 * 
 */
public class CustomerInfoDetailActivity extends Activity {
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case HandlerException.HttpURLConnection_not_HTTP_OK:
				...
				progressBar.setVisibility(View.GONE);
				Toast.makeText(CustomerInfoDetailActivity.this, "服务器没有响应!",
						Toast.LENGTH_SHORT).show();
				break;
			case HandlerException.Fail:

				progressBar.setVisibility(View.GONE);
				Toast.makeText(CustomerInfoDetailActivity.this, "加载服务器错误!",
						Toast.LENGTH_SHORT).show();
				break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.customer_info_detail);
		// 初始化
		init();
		// 添加事件
		Event();
	...
	private StringBuffer qyDetailUrl() {
		...
		sourroundQyUrl.append(SettingUtils.get("customer_detail_url"))
				.append("id=").append(id);
...
//				customerDetail.setKhwd(object.getString("khwd"));
	...
	// 上下文菜单，本例会通过长按条目激活上下文菜单
		...
		public boolean onContextItemSelected(MenuItem item) {
			...
			case ITEM1:
				// 在这里添加处理代码
				PhoneUtils.Tel(CustomerInfoDetailActivity.this, kh_telText.getText().toString()
						.trim());
				break;
			case ITEM2:
				// 在这里添加处理代码
