...
public class WdjtActivity extends Activity {
	private EditText kh_nameEditText, kh_jpEditText, kh_qpEditText,
			cardIdEditText, kh_phoneEditText, jrnrEditText;
	private String kh_name, kh_jp, kh_qp, cardId, kh_phone, jrnr;
	private TextView shengText, shiText, quText, jdText, sqText, zdyText,
			jgText, cjlbText, cjdjText, jrfsText, startTimeText, endTimeText;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wdjt);
		init();
		Event();
	}

	private void init() {
		settingUtils = new SettingUtils(WdjtActivity.this);
		...
		jrnrEditText = (EditText) this.findViewById(R.id.jrnr);
		...
		jrfsText = (TextView) this.findViewById(R.id.jrfs);
	...
	private void getValue() {
		...
		jrnr = jrnrEditText.getText().toString().trim();
	}
	...
	private void Event() {
		...
		this.findViewById(R.id.search).setOnClickListener(
				new OnClickListener() {
					...
					@Override
					public void onClick(View arg0) {
						Intent intent = new Intent(WdjtActivity.this,
								WdjtSearchActivity.class);
		...
		// 接入方式
		this.findViewById(R.id.jrfs).setOnClickListener(new OnClickListener() {
