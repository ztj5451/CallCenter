...
public class HuiFangActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.huifang);
		init();
		Event();
	}

	private void init() {
		settingUtils = new SettingUtils(HuiFangActivity.this);
	}
	...
	private void Event() {
		...
		// 结束回访
		this.findViewById(R.id.jshf).setOnClickListener(new OnClickListener() {
		...
		// 继续回访
		this.findViewById(R.id.jxhf).setOnClickListener(new OnClickListener() {
	...
	private StringBuffer huifangUrl() {
	...
	private void huifangAction(StringBuffer loginUrl) {
		try {
